...
const NON_GROCERY_RULES = [
  ...
  /ipad|galaxy\s*tab|smartphone|cell\s*phone|phone\s*case|laptop|macbook|surface|chromebook|monitor|screen|speaker|earbuds|camera|gaming|console|drone|smart\s*watch|wearable/,
];
